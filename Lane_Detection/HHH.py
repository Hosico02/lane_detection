...
class MainWindow(QTabWidget):
    def __init__(self, parent=None):
        ...
        self.time_3.timeout.connect(self.HHH)
        # 图片和视频
        self.SAVE = None
        self.img = None
        self.cap = None
        ...
        self.test_model = r'/Users/mack/Desktop/work/车道线检测/culane_18.pth'
    ...
    def Train(self):
        ...
        self.miou = 0.34
        self.fuck = 0.1
        self.bar.setValue(int(self.fuck))
        if self.fuck != 100:
            self.time_3.start(100)
        return

    def Tensorboard(self):
        self.process = QProcess(self)
        # self.process.start('tensorboard --logdir /Users/mack/Desktop/work/车道线检测/log')
        self.process.start('tensorboard --logdir /Users/mack/Desktop/work/Ultra-Fast-Lane-Detection-master/log')
